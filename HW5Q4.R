...
# The two methods are very similar. The means are slightly different but the confidence intervals overlap for the majority of the time. The MC confidence interval is slightly larger than the analytical formula 
